...
public class Card implements Comparable<Card> {
	// These are enum types that make the suits and ranks of the cards more readable.  
	// They are also used for comparison of cards, as shown in equals and compareTo below.  
	// You can access the type values directly using the class, which you will need to do 
	// to initialize your deck of cards.  See A1Help.java for a demo of this.
